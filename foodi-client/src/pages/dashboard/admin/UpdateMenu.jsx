          ...
          <div className="flex items-center gap-4">
            ...
            <div className="form-control w-full my-6">
              ...
              >
                ...
                <option value="salad">Acoustic</option>
                <option value="pizza">Electro-Acoustic</option>
                <option value="soup">Bass</option>
                <option value="dessert">Classical</option>
                <option value="drinks">Semi-Acoustic Guitar</option>
